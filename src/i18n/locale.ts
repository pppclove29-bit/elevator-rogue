...
const STRINGS = {
  ko: {
    ...
    'hud.angry': '불만',
    'hud.reputation': '평판',
    'cascade.entered': '⚠ 건물 평판이 임계에 도달했습니다',
    'cascade.exit': '평판 회복 — 정상 운영 복귀',
    'gameover.reason.reputation': '평판 0 — 건물이 버려졌습니다',
    'deal.title.both': '👼 천사 / 😈 악마 거래',
    'deal.title.devil_only': '😈 악마의 거래',
    'deal.subtitle.angel_open': '한 쪽만 선택 가능 — 악마와 거래하면 천사방 영구 봉인',
    'deal.subtitle.angel_sealed': '천사방은 이미 봉인됨 (악마 거래 이력)',
    'deal.skip': '거절 (비용 없음)',
    'revive.toast': '💀 당신의 건물은 무너지지 않았다 — 부활',
    'curse.entered': '⚠ 악재: {name}',
    'transform.toast': '✨ 당신은 {name}(으)로 변신했다!',
    'fragile.broken': '💔 {name} 산산조각났다',
    'mystery.title': '?? 미스터리 박스',
    'year.recap.title': '{year}년차 결산',
    'hud.modifier_count': '운영 변수: {n}',
    ...
    // ── 운영 변수 / 유물 / 보상 ────────
    'modifier.title': '운영 변수',
    'modifier.subtitle': '운영 변수 3장 중 1택 — 이번 런 동안 영구 지속 (SKIP 없음)',
    'modifier.tag.debuff': '불리',
    'modifier.tag.buff': '유리',
    'modifier.tag.mixed': '혼합',
    'modifier.note': '이번 런 동안 영구',
  ...
  en: {
    ...
    'cascade.entered': '⚠ Building reputation has hit critical',
    'cascade.exit': 'Reputation recovered — back to normal',
    'gameover.reason.reputation': 'Reputation 0 — the building was abandoned',
    'deal.title.both': '👼 Angel / 😈 Devil Deal',
    'deal.title.devil_only': '😈 Devil\'s Bargain',
    'deal.subtitle.angel_open': 'Pick one — devil deal seals the angel room forever',
    'deal.subtitle.angel_sealed': 'Angel room sealed (devil deal history)',
    'deal.skip': 'Decline (no cost)',
    'revive.toast': '💀 Your building stood firm — Revived',
    'curse.entered': '⚠ Setback: {name}',
    'transform.toast': '✨ You transformed into {name}!',
    'fragile.broken': '💔 {name} shattered',
    'mystery.title': '?? Mystery Box',
    'year.recap.title': 'Year {year} Recap',
    'hud.modifier_count': "Variables: {n}",
    ...
    // ── Operating Variable / Relic / Reward ──────
    'modifier.title': "Operating Variable",
    'modifier.subtitle': "Pick 1 of 3 variables — permanent for this run (no skip)",
    'modifier.tag.debuff': 'BAD',
    'modifier.tag.buff': 'GOOD',
    'modifier.tag.mixed': 'MIXED',
    'modifier.note': 'Permanent this run',
